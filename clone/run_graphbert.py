...
from models import GraphBertModel
...
def run():
    ...
    # args.config_name = r"G:\research\clone\examples\graphcodebert-base"
    # args.tokenizer_name = r"G:\research\clone\examples\graphcodebert-base"
    # args.model_name_or_path = r"G:\research\clone\examples\graphcodebert-base"
    ...
    results = {}
    if args.do_eval:
        checkpoint_prefix = 'checkpoint-best-f1/graphbert-model.bin'
        output_dir = os.path.join(args.output_dir, '{}'.format(checkpoint_prefix))
